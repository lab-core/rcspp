...
class ResourcePrototype {
    public:
        ...
        void reset(const ResourceClass& resource) {
            ...
            merge_rule_ = resource.merge_rule_;  // the same function object, so the same rule
        }
    ...
    protected:
        ...
        ///
        /// Avoids a virtual call in the join's hot loop. Refreshed wherever the feasibility
