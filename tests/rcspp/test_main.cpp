...
int main() {
    ...
    auto p =
    all_tests_rcspp<SimpleDominanceAlgorithmIterators, PushingDominanceAlgorithm, PullingDominanceAlgorithm>();
    passed += p.first;
    total += p.second;
    ...
    p =
    all_tests_rcspp_non_integer_dual_row_coef<SimpleDominanceAlgorithmIterators, PushingDominanceAlgorithm, PullingDominanceAlgorithm>();
    passed += p.first;
    total += p.second;
