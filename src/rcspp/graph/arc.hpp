...
class Arc {
    public:
        Arc(size_t arc_id, Node<ResourceType>& origin_node,
        ...
        Arc(size_t arc_id, Node<ResourceType>& origin_node,
            Node<ResourceType>& destination_node, double arc_cost,
            std::vector<Row> dual_rows = {})
            : Arc(arc_id, origin_node, destination_node, nullptr, arc_cost, std::move(dual_rows)) {}

        Arc(size_t arc_id, Node<ResourceType>& origin_node,
            Node<ResourceType>& destination_node, std::vector<Row> dual_rows = {})
