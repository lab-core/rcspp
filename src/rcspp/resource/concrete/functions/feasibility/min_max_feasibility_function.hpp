...
class MinMaxFeasibilityFunction
    ...
    public:
        MinMaxFeasibilityFunction(ValueType default_min, ValueType default_max, const std::map<size_t, std::pair<ValueType, ValueType>>* min_max_by_node_id = nullptr) : min_max_by_node_id_(min_max_by_node_id), min_(default_min), max_(default_max) {}
        MinMaxFeasibilityFunction(const std::map<size_t, std::pair<ValueType, ValueType>>* min_max_by_node_id) : min_max_by_node_id_(min_max_by_node_id) {}
