...
namespace rcspp {
  ...
  public:
    SizeFeasibilityFunction(size_t default_min_size, size_t default_max_size, const std::map<size_t, std::pair<size_t, size_t>>* min_max_size_by_node_id = nullptr) : min_max_size_by_node_id_(min_max_size_by_node_id), min_size_(default_min_size), max_size_(default_max_size) {}
    SizeFeasibilityFunction(const std::map<size_t, std::pair<size_t, size_t>>* min_max_by_node_id, size_t default_min_size = 0, size_t default_max_size = std::numeric_limits<size_t>::max() / 2) // prevent overflow
    : min_max_size_by_node_id_(min_max_by_node_id), min_size_(default_min_size), max_size_(default_max_size) {}
