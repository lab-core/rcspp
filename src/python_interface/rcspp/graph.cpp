...
void init_graph(py::module_& m) {
  py::class_<ConcreteGraph>(m, "Graph")
    ...
    .def("add_arc",
         ...
         py::arg("dual_rows") = std::vector<Row>{},
         py::return_value_policy::reference)
    .def("get_node", &ConcreteGraph::get_node, py::arg("id"), py::return_value_policy::reference)
  ...
  py::class_<ConcreteArc>(m, "Arc")
    .def(
      py::init<size_t, ConcreteNode*, ConcreteNode*, std::unique_ptr<ConcreteExpander>, double>(),
      py::arg("id"),
      py::arg("origin"),
      py::arg("destination"),
      py::arg("expander"),
    ...
    .def(
      ...
      static_cast<Arc<ResourceComposition<RealResource>>& (
        ResourceGraph<RealResource>::*)(const std::tuple<std::vector<
                                        ...
                                        std::optional<size_t>,
                                        double,
                                        std::vector<Row>)>(&ResourceGraph<RealResource>::add_arc),
