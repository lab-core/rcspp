...
//std::unique_ptr<ResourceComposition<RealResource, RealResource>> construct_resource_composition(
//	std::vector<double> real_vector1, std::vector<double> real_vector2) {
//
//	RealResourceFactory real_resource_factory(std::make_unique<RealResource>(0));
//
...
//
//	auto new_resource = resource_factory.make_default_resource(resource_components);
//
//	return new_resource;
//}
